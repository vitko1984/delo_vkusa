<script lang="ts">
  ...
  export let links = [
    ...
    { name: 'Таблицы', url: '/tables', svg: ['M4 6h16M4 10h16M4 14h16M4 18h16'] },
    { 
      name: 'Фото, картинки',
      url: '/images',
      svg: ['M20,4H16.83L15,2H9L7.17,4H4A2,2 0 0,0 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6A2,2 0 0,0 20,4M20,18H4V6H8.05L9.88,4H14.12L15.95,6H20V18M12,7A5,5 0 0,0 7,12A5,5 0 0,0 12,17A5,5 0 0,0 17,12A5,5 0 0,0 12,7M12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15Z']
    },
    {
      name: 'Формы',
      url: '/forms',
    ...
    },
    {
      ...
      sublinks: [
        { name: 'Вход', url: import.meta.env.VITE_LOGIN_PATH },
        { name: 'Создать аккаунт', url: '/pages/create-account' },
        { name: 'Восстановить пароль', url: '/pages/forgot-password' },
