...
<main class="h-full overflow-y-auto">
  <div class="container px-6 mx-auto grid">
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Стол администратора</h2>
    <!-- CTA -->
    <a
    ...
    >
      <div class="flex items-center">
        ...
        <span>Разместить этот проект на GitHub</span>
      </div>
      <span>Посмотреть больше &RightArrow;</span>
    </a>
    <!-- Cards -->
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
      ...
      <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Всего клиентов</p>
      ...
      <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Новые продажи</p>
      ...
      <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Ожидающие контакты</p>
    ...
    <!-- Charts -->
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Графики</h2>
    <div class="grid gap-6 mb-8 md:grid-cols-2">
      <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300">Доход</h4>
        <canvas id="pie" />
        <div class="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
          <!-- Chart legend -->
          <div class="flex items-center">
            <span class="inline-block w-3 h-3 mr-1 bg-blue-500 rounded-full" />
            <span>Зефирные корзины</span>
          </div>
          <div class="flex items-center">
            <span class="inline-block w-3 h-3 mr-1 bg-teal-600 rounded-full" />
            <span>Зефирные букеты</span>
          </div>
          <div class="flex items-center">
      ...
      <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300">Трафик</h4>
        <canvas id="line" />
        <div class="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
          <!-- Chart legend -->
          <div class="flex items-center">
